    ...
    <section className="min-h-screen bg-gradient-to-b from-navy-900 to-navy-800 py-12 sm:py-16 lg:py-20">
      <Container className="mx-auto max-w-5xl">
        ...
        <div className="mb-12 rounded-2xl border border-blue-900/40 bg-navy-800/40 p-8">
          ...
          <p className="text-blue-300 text-sm leading-relaxed mb-4">
            Beyond renting a generic frontier model, an owned, fine-tuned sales AI trained on VoltSol&apos;s own closing methodology &mdash; residential and enterprise/C&amp;I. <strong className="text-white">Solar is the first vertical, not the only one</strong> &mdash; the architecture is built so additional verticals can be added later on the same platform. Makes the case for ownership on two independent grounds: capability/cost, and control over where sensitive conversation data and proprietary sales methodology actually live &mdash; legal discovery exposure, IP protection, and future data-residency requirements (healthcare, financial services, government contracting) that a third-party-API-dependent architecture can&apos;t serve at all. Glossary-first for mixed technical/non-technical readers, corpus-build plan, hosting/HA architecture, and a phased rollout targeting <strong className="text-white">January 1, 2027</strong>. Externally audited across four rounds by an independent AI reviewer (Fable 5) before publication &mdash; see Section 9&apos;s honest risk flags and Section 10&apos;s open decisions.
          </p>
          <div className="flex flex-wrap gap-3">
            <a
